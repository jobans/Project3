...
<!-- 내용이 들어갈곳  -->
	...
	<form  method="post">
	    ...
	    <div class="form-group row" style="width: 50%;">
	        ...
	        <div class="col-sm-9">
	            <input type="text" class="form-control" id ="n_subject" name="n_subject" value="${nvo.n_subject }"  >
	        </div>
	    </div>
	    <div class="form-group row" style="width: 50%;">
	        <label for="lname" class="col-sm-3 text-left control-label col-form-label">내용</label>
	        <div class="col-sm-9">
	            <textarea class="form-control" rows="5" cols="60" id ="n_contents" name="n_contents" >${nvo.n_contents }</textarea>
	        </div>
	    </div>
	    ...
	    <div align="center">
	    	<br />
	    	<br /><br />
	    	<button type="submit" class="btn btn-success" id="btn_no_write" name="btn_modify">수정</button>
	    </div>
